...
cna <- read_tsv('Data/Data-Uncompressed-Original/transcriptomics.cct')
cna[is.na(cna)] <- 0
...
write_csv(train,'Data/Distribution-Data-Set/train_transcriptomics_distribution.csv')
write_csv(test,'Data/Distribution-Data-Set/test_transcriptomics_distribution.csv')
...
plot
ggsave('Analysis-Scripts/Distribution-Analysis/pca-resampling-transcriptomics.png',plot)
