...
data = pd.read_csv('TranscriptomicsResults/transcriptomics_results1.csv')

for i in range(2,101):
        temp = pd.read_csv('TranscriptomicsResults/transcriptomics_results' + str(i) + '.csv')
...
ax.set_title('Mean Accuracy of Learners on 100 Transcriptomics Resampling Datasets')
ax.yaxis.grid(True)
